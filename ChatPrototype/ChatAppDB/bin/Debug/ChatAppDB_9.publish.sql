...
GO
/*
The column [Chat].[ServerChannel].[ServerChannelId] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [Chat].[ServerChannel])
...
CREATE TABLE [Chat].[tmp_ms_xx_ServerChannel] (
    ...
    PRIMARY KEY CLUSTERED ([ServerId] ASC, [ChannelId] ASC)
);
